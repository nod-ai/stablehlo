...
//              CHECK: {mhlo.frontend_attributes = {some_other_attr = "val"}}
  %0 = "stablehlo.abs" (%arg0) { mhlo.frontend_attributes = {some_other_attr = "val"} } : (tensor<2xf32>) -> tensor<2xf32>
...
//              CHECK: {device_domain = "super", mhlo.frontend_attributes = {some_other_attr = "val"}}
  %0 = "stablehlo.abs" (%arg0)
    { mhlo.frontend_attributes = {some_other_attr = "val", device_domain="super"} }
