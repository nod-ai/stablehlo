...
// CHECK{LITERAL}: module @pjit_f attributes {mhlo.cross_program_prefetches = [], mhlo.dynamic_parameter_bindings = [], mhlo.is_dynamic = false, mhlo.spmd_output_sharding = "{devices=[1,4,2]0,1,2,3,4,5,6,7 last_tile_dim_replicate}", mhlo.spmd_parameters_shardings = ["{devices=[1,2,4]0,2,4,6,1,3,5,7 last_tile_dim_replicate}", "{devices=[1,2,4]0,2,4,6,1,3,5,7 last_tile_dim_replicate}"], mhlo.use_auto_spmd_partitioning = false} {
